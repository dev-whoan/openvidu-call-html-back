...
exports.app.post('/login', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        ...
        req.headers.authorization = 'Basic ' + Buffer.from("".concat(username, ":").concat(password)).toString('base64');
        callback = function () {
            console.log('Login succeeded');
            res.status(200).send('');
        };
        return [2 /*return*/, (0, AuthService_1.authorizer)(req, res, callback)];
    });
}); });
exports.app.post('/admin/login', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var password, isAdminTokenValid, isAuthValid, token, recordings, error_1, code;
    var _a, _b, _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                password = req.body.password;
                isAdminTokenValid = openviduService.adminTokens.includes((_a = req['session']) === null || _a === void 0 ? void 0 : _a.token);
                isAuthValid = password === config_1.CALL_ADMIN_SECRET || isAdminTokenValid;
                if (!isAuthValid) return [3 /*break*/, 5];
                _d.label = 1;
            case 1:
                _d.trys.push([1, 3, , 4]);
                if (!((_b = req['session']) === null || _b === void 0 ? void 0 : _b.token) || !openviduService.adminTokens.includes((_c = req['session']) === null || _c === void 0 ? void 0 : _c.token)) {
            ...
            case 2:
                recordings = _d.sent();
                console.log("".concat(recordings.length, " recordings found"));
...
exports.app.post('/admin/logout', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        openviduService.adminTokens = openviduService.adminTokens.filter(function (token) { return token !== req['session'].token; });
        req['session'] = {};
        return [2 /*return*/];
    });
}); });
